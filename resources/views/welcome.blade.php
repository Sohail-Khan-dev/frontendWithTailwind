...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <div class="min-h-screen bg-gray-100 min-w-screen">
    ...
    <nav class="bg-gray-300 w-max h-screen  ">
        <ul class="pt-10 px-10 space-y-3  cursor-pointer font-semibold text-xl ">
            <li class=""> <a href="/">       Home         </a> </li>
            <li class=""> <a href="/landing">Landing Page </a> </li>
            <li class=""> <a href="/grocery">Groceries    </a> </li>
        </ul>
    </nav>
   </body>
</html>
